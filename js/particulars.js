...
function initialization (data) {
	...
	$("#Year").text(data[idSerial].bibtex.year)
	  ...
	  for (var i=0;i<data[idSerial].contents[0].images.length;i++) { //第一个内容区域 	
	  	var item='<div style="text-align: center;"><img width="300" src="'+data[idSerial].contents[0].images[i].uri+'" class="particulars-img image1" />'
	  ...
	  for (var i=1;i<data[idSerial].contents.length;i++) { //第二个内容区域 	
         var cycle=''
          ...
          cycle +='<div style="text-align: center;"><img width="300" src="'+data[idSerial].contents[i].images[k].uri+'" class="particulars-img" /></div>'
